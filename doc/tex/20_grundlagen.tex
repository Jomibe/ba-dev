...
\begin{lstlisting}[caption={Beispiel für eine Erfasste syslog-Meldung in Graylog.}, label=bsp-graylog-syslog]
GET http://10.10.12.1:9000/api/cluster
