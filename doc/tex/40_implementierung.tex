...
\begin{lstlisting}[caption={Auszug aus der Datei config.toml}, label=config-toml]
[Webserver]
...
\begin{lstlisting}[caption={Anfrage der Software an Graylog mit den ermittelten Daten}, label=config-toml]
...
\begin{lstlisting}[caption={Aliasdefinitionen in der Datei config.toml}, label=alias-config-toml]
[Webserver]
